...
- [`TemporALL`](https://github.com/thatais/temporall) — Plataforma com IA integrando APIs da NASA (GIBS & Giovanni) para recomendações climáticas inteligentes
- [`gap-buffer-editor`](https://github.com/thatais/gap-buffer-editor) — Implementação de buffer de texto de alta performance e estruturas de dados em C
- [`urban-safety-ai`](https://github.com/thatais/urban-safety-ai) — Pesquisa e modelagem de rotas seguras e análise de risco urbano com inteligência artificial
